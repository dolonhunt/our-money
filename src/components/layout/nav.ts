...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/bills", label: "Bills & Subscriptions", icon: Receipt, group: "Plan" },
  { href: "/upcoming", label: "Upcoming", icon: CalendarClock, group: "Plan" },
  { href: "/reports", label: "Reports & Forecast", icon: BarChart3, group: "Insights" },
